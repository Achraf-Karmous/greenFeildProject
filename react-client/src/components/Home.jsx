...
class Home extends Component {
	...
	search() {
		...
		axios
			.post("/images/find", { owner: this.state.search })
			.then(({ data }) => {
				...
				<div className='informations'>
					<div className='safety-tips'>
						...
						<div>
							<h3>
								Safety Tips{" "}
								<img src='https://img.icons8.com/ios/15/000000/info--v4.png' />
							</h3>
							<p>
								Trust is the basis of successful exchanges.For
								this we recommend that you always use the chat
								and notify us of any inappropriate announcement
								or exchange.We are here for you !
							</p>
						</div>
					</div>
					<Testimonial />
